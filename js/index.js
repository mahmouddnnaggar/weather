...
let afterTomorrowDays= d.toLocaleDateString("en-us",{weekday:"long"});
    ...
    let todayCol =`
        ...
        <img class="condition-icon" src="${data.current.condition.icon}"></img>
        </div>
    ...
    <img class="p-3 condition-icon" src="${data.forecast.forecastday[1].day.condition.icon}"></img>
    ...
    <div class="card-body">
    <div class="deg  d-flex flex-column align-items-center justify-content-around">
    <img class="p-3 condition-icon" src="${data.forecast.forecastday[2].day.condition.icon}"></img>
